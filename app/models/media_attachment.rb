...
class MediaAttachment < ApplicationRecord
  ...
  VIDEO_FILE_EXTENSIONS = %w(.webm .mp4 .m4v .mov .mkv).freeze
  AUDIO_FILE_EXTENSIONS = %w(.ogg .oga .mp3 .wav .flac .opus .aac .m4a .3gp .wma .mka).freeze
  ...
  VIDEO_MIME_TYPES             = %w(video/webm video/mp4 video/quicktime video/ogg video/x-matroska).freeze
  VIDEO_CONVERTIBLE_MIME_TYPES = %w(video/webm video/quicktime).freeze
  AUDIO_MIME_TYPES             = %w(audio/wave audio/wav audio/x-wav audio/x-pn-wave audio/ogg audio/mpeg audio/mp3 audio/webm audio/flac audio/aac audio/m4a audio/x-m4a audio/mp4 audio/3gpp video/x-ms-asf audio/x-matroska).freeze
